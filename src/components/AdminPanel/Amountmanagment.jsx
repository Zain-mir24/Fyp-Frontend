...
export default function Amountmanagment(props) {
    ...
    const viewData = async () => {
        try {
            const res = await axios.get("http://localhost:9000/admin/viewamountDetail");
            setData(res.data)
        ...
        <div className="row">
            ...
            <div className="col-lg-12">
                ...
                <Row>
                    <Col span={12}>
                        <h3>
                            Add amountDetail for this beneficiary
                        </h3>
                        <Form>
                            <Form.Item rules={[
                            ...
                            <Form.Item
                                rules={[
                                    { required: true, message: "Please Enter amount recieved in pounds" },
                                ]}
                            >
                                <Input
                                    required
                            ...
                            <Form.Item
                                rules={[
                                    { required: true, message: "Please Enter pound rate" },
                                ]}
                            >
                                <Input
                                    required
                            ...
                            <Form.Item
                                rules={[
                                    { required: true, message: "Please Enter how much was given to deserver" },
                                ]}
                            >
                                <Input
                                    required
